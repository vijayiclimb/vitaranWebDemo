...
import './singleCategoryLow.scss';
import LowGraphCategory from './LowCategoryGraph';

const SingleCategoryLow = () => {
    return (
        <div className="CategoryContainerLow">
        <div className="detailsLow">
            <div className="CategoryDetailLow">
                ...
                <div className="sideDetailsLow">
                    <div className="sideListLow"><label className="sideTitleLow">Category Name:</label><label className="sideValueLow">Gold Flake Kings Red</label></div>
                    <div className="sideListLow"><label className="sideTitleLow">Category:</label><label className="sideValueLow">Cigarettes</label></div>
                    <div className="sideListLow"><label className="sideTitleLow">Category:</label><label className="sideValueLow">Gold Flake</label></div>
                    <div className="sideListLow"><label className="sideTitleLow">Brand:</label><label className="sideValueLow">ITC Limited</label></div>
                </div>
            </div>
            <div className="CategoryTableLow">
...
export default SingleCategoryLow
