...
import './styles/CategoryWiseRatesTable.scss'
...
const CategoryWiseRatesTable = () => {
    const classes = useStyles();
    const [page, setPage] = React.useState(0);
    const [rowsPerPage, setRowsPerPage] = React.useState(10);
    const columns = ["SKU Name","Lowest Price","Highest Price","Compare Price"];
                        ...
                        <TableBody>
                            {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row,index) =>(
                                <TableRow key={index}>
                                    ...
                                    <TableCell  align="center"><button className="lal">Compare</button></TableCell>
...
export default CategoryWiseRatesTable