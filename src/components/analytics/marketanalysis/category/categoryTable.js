                  ...
                  <TableBody>
                    {
                      Product.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell className={classes.TableBody} align="center">{item.no_of_retailer}</TableCell>
                          <TableCell className={classes.TableBody} align="center">{item.avgValue}</TableCell>
                          <TableCell className={classes.TableBody} align="center">{item.activeUsers}</TableCell>


                          <TableCell className={classes.TableBody} align="center"><RedButton variant="contained" color="primary" type="button">Detail</RedButton></TableCell>
                        </TableRow>
                      ))
                    }
