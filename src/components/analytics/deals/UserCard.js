            ...
            <div className="two">
                ...
                <div className="userUsageWrapper">
                    <div className="UsageOne">
                        <label className="usageTitle">Deals Used</label>
                    ...
                    <div className="UsageTwo">
                        ...
                        <div className="dropWrapper">
                            ...
                            <label className="DealdropTitle">Deal Id</label>
                            <label className="DealdropValue">VIT56</label>
                            <label className="DealdropValue">VIT56</label>
                            <label className="DealdropValue">VIT56</label>
                            <label className="DealdropValue">VIT56</label>
                            </div>
                            <div className="droplist">
                            <label className="DealdropTitle">Date</label>
                            <label className="DealdropValue">10 May 2021</label>
                            <label className="DealdropValue">10 May 2021</label>
                            <label className="DealdropValue">10 May 2021</label>
                            <label className="DealdropValue">10 May 2021</label>
                            </div>
                            <div className="droplist">
                            <label className="DealdropTitle">Order Id</label>
                            <label className="DealdropValue">RE1010203211745-A105</label>
                            <label className="DealdropValue">RE1010203211745-A105</label>
                            <label className="DealdropValue">RE1010203211745-A105</label>
                            <label className="DealdropValue">RE1010203211745-A105</label>
                            </div>
                            <div className="droplist">
                            <label className="DealdropTitleV">Value Per transaction</label>
                            <label className="DealdropValueV">1125.00</label>
                            <label className="DealdropValueV">1125.00</label>
                            <label className="DealdropValueV">1125.00</label>
                            <label className="DealdropValueV">1125.00</label>
                            </div>
