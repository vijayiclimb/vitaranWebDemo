...
export const CouponMgtReasonContainer = styled.div`
 display:flex;
    flex-direction: row;
    align-items: center;
    justify-content: center;
...
export const CouponMgtautoCompleteContainer = styled.div`
margin-bottom:10px;
margin-left:15px;
flex:2;  
`

export const CouponMgtButtonContainer = styled.div`
flex:1;
`
...
export const CouponFormTitlepro = styled.label`
                       text-align: right;
                        display: flex;
                       margin-right:15px;
                        align-items:center;
